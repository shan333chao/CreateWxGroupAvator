...
{
    public class HeptaImageStrategy : IimageResizeStrategy
    {

        public HeptaImageStrategy()
        {
        }

        public HeptaImageStrategy(IEnumerable<String> ImagePaths, String imageTemplate)
        {
        ...
        public List<List<AvactorInfo>> GetImageSize()
        {
            ...
            AvactorInfo outsideWidth = new AvactorInfo { FilePath = TempImage, Width = 54, Heigh = 50, IsResize = true };
            ...
            floor2.Add(new AvactorInfo { FilePath = ImagePaths.ElementAt(1), Width = 50, Heigh = 50, IsResize = false });
            floor2.Add(commonwidth);
            ...
            floor3.Add(new AvactorInfo { FilePath = ImagePaths.ElementAt(4), Width = 50, Heigh = 50, IsResize = false });
            floor3.Add(commonwidth);
